...
primitive_types = {
	...
	BasicPrimitive('LAST'): Arrow(List(INT),INT),
	BasicPrimitive('ACCESS'): Arrow(List(INT),INT),
	BasicPrimitive('MINIMUM'): Arrow(List(INT),INT),
	BasicPrimitive('MAXIMUM'): Arrow(List(INT),INT),
	BasicPrimitive('LENGTH'): Arrow(List(INT),INT),
	BasicPrimitive('COUNT[<0]'): Arrow(List(INT),INT),
	BasicPrimitive('COUNT[>0]'): Arrow(List(INT),INT),
	BasicPrimitive('COUNT[%2==0]'): Arrow(List(INT),INT),
	BasicPrimitive('COUNT[%2==1]'): Arrow(List(INT),INT),
	BasicPrimitive('SUM'): Arrow(List(INT),INT),
	BasicPrimitive('TAKE'): Arrow(INT, Arrow(List(INT), List(INT))),
	BasicPrimitive('DROP'): Arrow(INT, Arrow(List(INT), List(INT))),
	BasicPrimitive('SORT'): Arrow(List(INT), List(INT)),
	BasicPrimitive('REVERSE'): Arrow(List(INT), List(INT)),
	BasicPrimitive('FILTER[<0]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('FILTER[>0]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('FILTER[%2==0]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('FILTER[%2==1]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[+1]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[-1]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[*2]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[/2]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[*(-1)]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[**2]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[*3]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[/3]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[*4]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('MAP[/4]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('ZIPWITH[+]'): Arrow(List(INT), Arrow(List(INT), List(INT))),
	BasicPrimitive('ZIPWITH[-]'): Arrow(List(INT), Arrow(List(INT), List(INT))),
	BasicPrimitive('ZIPWITH[*]'): Arrow(List(INT), Arrow(List(INT), List(INT))),
	BasicPrimitive('ZIPWITH[MIN]'): Arrow(List(INT), Arrow(List(INT), List(INT))),
	BasicPrimitive('ZIPWITH[MAX]'): Arrow(List(INT), Arrow(List(INT), List(INT))),
	BasicPrimitive('SCANL1[+]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('SCANL1[-]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('SCANL1[*]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('SCANL1[MIN]'): Arrow(List(INT), List(INT)),
	BasicPrimitive('SCANL1[MAX]'): Arrow(List(INT), List(INT)),
