...
semantics = {
	...
	'ZIPWITH[+]'  : lambda l1, l2: [x + y for (x,y) in zip(l1,l2)],
	'ZIPWITH[-]'  : lambda l1, l2: [x - y for (x,y) in zip(l1,l2)],
	'ZIPWITH[*]'  : lambda l1, l2: [x * y for (x,y) in zip(l1,l2)],
	'ZIPWITH[MAX]'  : lambda l1, l2: [(x if x > y else y) for (x,y) in zip(l1,l2)],
	'ZIPWITH[MIN]'  : lambda l1, l2: [(y if x > y else y) in zip(l1,l2)],
