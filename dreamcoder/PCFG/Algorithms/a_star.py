...
def a_star(G : PCFG):
    ...
    heappush(frontier, ( -G.max_probability[G.start].probability[(G.__hash__(),G.start)], (None, initial_non_terminals, 1)))
        ...
        if len(non_terminals) == 0: 
            ...
            for P in G.rules[S]:
                ...
                for arg in args_P:
                    ...
                    new_max_probability *= G.max_probability[arg].probability[(G.__hash__(),arg)]
